...
if __name__ == "__main__":
    ...
    def aggregate_data(count):
        Aggregate_Data = [0] * 200
        for i in range(count):
            ...
            for i in range(len(list)):
                Aggregate_Data[i] = Aggregate_Data[i] + list[i]
        Aggregate_Data = [x / count for x in Aggregate_Data]
    ...
    def animate(i):
        ...
        Aggregate_Data = aggregate_data(10)
    ...
    while True:
        ...
        Sonar.set_ping_interval(100,True)        # INTERVALI BURADAN DEĞİŞTİR
        if data:
